...
* Click the [Launch link](https://console.aws.amazon.com/cloudformation/home?region=us-west-2#/stacks/new?stackName=ethminer&templateURL=https://aws-ethminer.s3.amazonaws.com/template-eth-default-vpc.yml) or create the stack manually:
